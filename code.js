...
class linkcommand_LinkCommand extends Command {
    ...
    constructor(editor) {
       ...
       */
      this.manualDecorators = new src_collection["default"]();
       ...
       */
      this.automaticDecorators =
        new automaticdecorators_AutomaticDecorators();
    }
    ...
    refresh() {
      ...
      const selectedElement =
        ...
        first_first(selection.getSelectedBlocks());
